...
| 视觉描述 | Qwen3VL local client, Cloud Qwen-VL fallback, Vinci legacy | `app/services/llm_clients/qwen3vl.py`, `app/services/llm_clients/qwen_vl_cloud.py`, `app/services/llm_clients/vinci.py` |
...
services/ 已按业务域分组，旧路径 → 新路径映射见 `CHANGELOG.md` 2026-05-18 条目。
